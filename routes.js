...
exports.configure = function (app) {	
				...
				rest.executeOperation(req, res, req.user, "GetZoneBinary", [ copyFrom ], function (error, response) {
					if (error) {
						...
						rest.executeOperation(req, res, req.user, "RestoreZoneBinary",
							[ name, /*rest.nameserverGroupName*/req.user.email, response ], function (error, response) {
	...
	app.post('/importzone/:zoneName', auth.ensureAuthenticated, function (req, res) {
		...
		rest.executeOperation(req, res, req.user, "RestoreZoneBinary", [ name, /*rest.nameserverGroupName*/req.user.email, req.body.zone.replace(/\r/g, '') ], function (error, response) {
			if (error) {
